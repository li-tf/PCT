...
六组正式仿真已于2026-07-17全部完成，工作站总墙钟时间约25.4小时。S1--S6
ROOT、manifest和QC均已复制到当前项目；S6用于阶段1，S2--S5用于阶段2--4，
S1用于高通量锁定确认。这里保留运行包和原始QC，不重复保存大型ROOT。

截至2026-07-30，S1、S4、S5及其Stage 6B正式结果继续保留在本地；S2、S3和
S6大型数据已迁入第一批冷归档。仿真配置和QC仍在本目录，恢复路径见
